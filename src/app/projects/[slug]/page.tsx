    ...
    <div className="px-6 md:px-12 lg:px-24 py-20">
      <div className="max-w-4xl">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          ...
          <div className="rounded-3xl border border-neutral-800 bg-neutral-950/60 p-5">
            <p className="text-xs uppercase tracking-[0.2em] text-neutral-500">Problem</p>
            <p className="mt-3 text-neutral-300">{project.problem}</p>
          </div>

          <div className="rounded-3xl border border-neutral-800 bg-neutral-950/60 p-5">
            <p className="text-xs uppercase tracking-[0.2em] text-neutral-500">Impact</p>
        ...
        <div className="mt-14 space-y-8">
          {project.sections.map((section) => (
            <section
              key={section.heading}
              className="rounded-3xl border border-neutral-800 bg-neutral-950/50 p-7"
            >
