      ...
      <div className="max-w-4xl">
        ...
        <div className="mt-10 flex flex-wrap gap-3">
          ...
          <a
            href="/resume/Harish_Prabhu_Resume.pdf"
            download
            className="rounded-2xl border border-neutral-700 px-5 py-3 font-medium text-white hover:border-neutral-500"
          >
            Download Resume
          </a>
        </div>
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-2">
          <div className="rounded-3xl border border-neutral-800 bg-neutral-950/60 p-7">
            <h2 className="text-2xl font-semibold text-white">Role Fit</h2>
        ...
        <div className="mt-10 rounded-3xl border border-neutral-800 bg-neutral-950/60 p-7">
        ...
        <div className="mt-10 rounded-3xl border border-dashed border-neutral-800 p-7">
          <p className="text-neutral-500">
            Add your PDF resume later at: <span className="text-neutral-300">public/resume/Harish_Prabhu_Resume.pdf</span>
          </p>
        </div>
      </div>
    </div>
